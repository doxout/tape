...
Test.prototype.run = function () {
    ...
    try {
        var p = this._cb && this._cb(this),
            isPromise = p != null && typeof(p.then) === 'function';
        var self = this;
        if (isPromise)
            p.then(function() {
                self.end();
...
Test.prototype._assert = function assert (ok, opts) {
    ...
    var res = {
        ...
        stack: defined(extra.stack, opts.stack)
    };
    ...
    var err = (res.stack || e.stack || '').split('\n');
...
Test.prototype.assertionError
= function assertionError(e, msg, extra) {
    this._assert(!e, {
        stack: e.stack,
        message: defined(msg, String(e)),
        operator: defined(e.operator, 'error'),
        actual: defined(e.actual, e),
        expected: e.expected,
        extra: defined(extra, e.extra)
    });
}
